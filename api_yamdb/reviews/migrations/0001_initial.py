# Generated by Django 2.2.16 on 2022-12-02 21:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='user', max_length=25, verbose_name='Роль')),
                ('confirmation_code', models.SlugField(blank=True, max_length=5, null=True)),
